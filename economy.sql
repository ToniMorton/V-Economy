...
--
-- Host: localhost
-- Generation Time: Oct 06, 2020 at 11:53 PM
...
CREATE TABLE `cad` (
  `CaseNumber` int(10) NOT NULL,
  `CallerID` int(11) NOT NULL,
  `Location` text NOT NULL,
  `Call Description` text NOT NULL,
  `Suspect Description` text NOT NULL
...
--
ALTER TABLE `cad`
  MODIFY `CaseNumber` int(10) NOT NULL AUTO_INCREMENT;
